...
public class MailUtils {
    public static void sendMail(String to,String title,String code) throws Exception{
        ...
        // 设置发件人邮箱地址
        message.setFrom(new InternetAddress("18439443515@163.com"));
        // 设置收件人邮箱地址
//             message.setRecipients(Message.RecipientType.TO, new InternetAddress[]{new InternetAddress("xxx@qq.com"),new InternetAddress("xxx@qq.com"),new InternetAddress("xxx@qq.com")});
        ...
        // 连接自己的邮箱账户
        transport.connect("18439443515@163.com", "SBMMBSAHCMPDUOWC");// 密码为QQ邮箱开通的stmp服务后得到的客户端授权码
        // 发送邮件
